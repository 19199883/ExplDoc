...
#define SL_EES_API_VERSION    "2.0.3.51"				///<  api版本号
...
struct EES_AccountOptionPosition
{
	...
	unsigned int		m_InitOvnQty;					///< 隔夜仓初始数量，这个值不会变化，除非通过HelpDesk手工修改		
	unsigned int		m_CurOvnQty;
	unsigned int		m_CurTodayQty;
	unsigned int		m_CoverOvnLockedQty;
	unsigned int		m_CoverTodayLockedQty;
